...
values('Alessandro dos Santos', '123456', 1),
('Perola', '123456', 1)
go

insert into Produtos(nome, preco,idUsuarioCadastro, ativo)
values('A batalha do apocalipse', 45.00, 1, 1),
('Use a Cabeça Java', 95.00, 1, 1)
go